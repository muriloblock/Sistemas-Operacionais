...
TELA    DEFINE 6
TELAOK  DEFINE 7
RAND    DEFINE 18 ; Definição para o dispositivo de número aleatório

LIMPA   DEFINE 10 ; \n, limpa a linha

         ; Gera um número aleatório antes de começar o jogo
         chama gera_rand
         armm segredo ; Armazena o número aleatório como o número a ser adivinhado
...
; gera um número aleatório e armazena em A
gera_rand espaco 1
         le RAND         ; Lê o número aleatório do dispositivo
         ret gera_rand
...
chute    espaco 1
segredo  espaco 1 ; A variável segredo agora é apenas espaço para armazenar o número aleatório
